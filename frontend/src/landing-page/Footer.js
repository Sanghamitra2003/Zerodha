            ...
            <div className="container border-top mt-5 pt-5">
                <div className="row">
                    <div className="col">
                        ...
                        />
                        <p>
                            © 2010 - 2026, Zerodha Broking Ltd. All rights
                            reserved.
                        </p>

                        <div
                            className="d-flex gap-4 pt-3"
                        ...
                        <div
                            className="d-flex border-top pt-3 gap-4 mt-3"
                            style={{ fontSize: "1.5rem", color: "#666" }}
                        >
                ...
                <div
                    className="d-flex flex-wrap justify-content-center align-items-center gap-4 px-5 py-3 border-top text-secondary"
